...
void setup()
{
  ...
  //
  //Population
  pic1 = loadImage(".../Images Used/Landscape/mqdefault.jpg");
  pic2 = loadImage(".../Images Used/Landscape/20Ounce_NYAS-Apples2.png");
  pic3 = loadImage(".../Images Used/Portrait/istockphoto-1154935375-612x612.jpg");
